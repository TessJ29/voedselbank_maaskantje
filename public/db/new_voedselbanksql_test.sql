...
INSERT INTO ProductPerLeverancier (Id, leverancierId, productId, DatumAangeleverd, DatumEerstVolgendeLevering, isActive, comment, createdAt, updatedAt)
VALUES
    (NULL, 4, 1, '2023-04-12', '2023-08-16', 1, NULL, SYSDATE(), SYSDATE())
	,(NULL, 4, 2, '2023-03-02', ' 2023-06-19', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 2, 3, '2023-07-16', '2023-07-23', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 1, 4, '2023-02-12', '2023-07-20', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 4, 5, '2023-05-19', '2023-06-02', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 1, 6, '2023-06-23', '2023-01-04', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 4, 7, '2023-06-20', '2023-04-07', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 4, 8, '2023-05-02', '2023-03-04', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 4, 9, '2022-12-04', '2023-03-28', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 3, 10, '2023-03-07', '2023-04-19', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 3, 11, '2023-02-04', '2023-04-23', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 3, 12, '2023-02-28', '2023-03-02', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 3, 13, '2023-03-19', '2023-03-16', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 2, 14, '2023-03-23', '2023-04-25', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 2, 15, '2023-02-02', '2023-04-13', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 1, 16, '2023-02-16', '2023-04-23', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 1, 17, '2023-03-25', '2023-03-21', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 1, 18, '2023-03-13', '2023-04-30', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 1, 19, '2023-03-23', '2023-04-27', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 4, 20, '2023-02-21', '2023-04-18', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 2, 21, '2023-03-31', '2023-04-14', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 1, 22, '2023-03-27', '2023-04-14', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 3, 23, '2023-04-11', '2023-05-14', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 3, 24, '2023-04-07', '2023-05-14', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 1, 25, '2023-05-05', '2023-05-12', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 2, 26, '2023-05-02', '2023-05-09', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 1, 27, '2022-12-22', '2023-01-22', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 4, 28, '2022-12-12', '2023-01-19', 1, NULL, SYSDATE(), SYSDATE())
    ,(NULL, 4, 29, '2023-07-16', '2023-05-12', 1, NULL, SYSDATE(), SYSDATE());
